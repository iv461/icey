...
icey::Stream<int> receive(std::shared_ptr<icey::Node> node) {
  icey::SubscriptionStream<std_msgs::msg::String> sub = node->icey().create_subscription<std_msgs::msg::String>("/strings");
