...
int main(int argc, char **argv) {
  ...
  auto service1 =
      icey::create_observable<icey::ServiceClient<ExampleService>>("set_bool_service1", 1s);
  auto service2 =
      icey::create_observable<icey::ServiceClient<ExampleService>>("set_bool_service2", 1s);
  auto service3 =
      icey::create_observable<icey::ServiceClient<ExampleService>>("set_bool_service3", 1s);
