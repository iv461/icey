...
int main(int argc, char **argv) {
    ...
    /// There are pre-defined events on which we can register, this callback is called immediatelly after all parameters are available, 
    /// but before everything else (timers, subscribers, publishers etc.) is initialized.
